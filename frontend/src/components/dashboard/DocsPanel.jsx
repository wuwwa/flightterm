...
const SECTIONS = [
  ...
  },
  {
    title: 'Data Sources',
    items: [
      { term: 'Airplanes.live', color: 'text-mag', desc: 'Default source for regional tracking. Unfiltered ADS-B/MLAT including military and blocked aircraft. Provides 50+ fields per aircraft: IAS, TAS, Mach, roll, wind, temperature, MCP/FMS altitudes, nav modes. 1 req/sec, no credits, no auth. Regions covered via tiled 250nm point queries.' },
